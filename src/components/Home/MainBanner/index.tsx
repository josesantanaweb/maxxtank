  ...
  return (
    <div className="flex justify-center mb-10">
      <div className="container flex items-center justify-between h-[600px] gap-10 mx-auto">
        <div className="flex flex-col items-start justify-center w-[40%] 2xl:w-[35%] h-full">
          <h4 className="mb-3 text-[42px] 2xl:text-[64px] font-[900] text-black leading-[42px] 2xl:leading-[65px]">
            EL AGUA
